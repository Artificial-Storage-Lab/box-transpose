...
\centering
\begin{tikzpicture}
\node[inner sep=2pt] (figsteps) {\input{sections/3-design/_generated/steps-fig.tex}};
...
search stays flat, ending at \stepsFigTopSearch{} swaps against
\stepsFigTopBaseline{} at rank~\stepsFigTopRank{}.}
\label{fig:steps}
\end{figure}
